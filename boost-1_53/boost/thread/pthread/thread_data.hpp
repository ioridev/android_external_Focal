...
#define BOOST_THREAD_DEFINES_THREAD_ATTRIBUTES_NATIVE_HANDLE
    ...
    namespace detail
    {
        ...
        struct BOOST_THREAD_DECL thread_data_base : enable_shared_from_this<thread_data_base>
        {
            ...
            //#endif
            thread_data_base() : thread_handle(0),
        ...
        public:
            explicit interruption_checker(pthread_mutex_t *cond_mutex, pthread_cond_t *cond) : thread_info(detail::get_current_thread_data()), m(cond_mutex),
